"""Settings — category and budget management."""
...
st.markdown('<div class="settings-header"><h2>Settings</h2><p>Manage budgets and expense categories</p></div>', unsafe_allow_html=True)
